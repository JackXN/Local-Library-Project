...
// const numberOfBorrows = (accounts,books) => books.borrows.reduce((acc, books))
...
const numberOfBorrows = books.reduce((acc, book) => acc += book.borrows.filter(borrow => borrow.id === account.id.length, 0))
